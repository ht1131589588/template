...
class Progress extends Component {
    ...
    render() {
        ...
        return (
            <div className={styles["compt-progress"]} style={boxStyle} ref={this.state.processBox}>
                <div className={styles["main"]} style={bigCircleStyle}>
                    <div className={styles["processBar"]} style={processStyle}></div>
                    <div className={styles["cont"]} style={circleStyle}>
                        <p className={styles["title"]}>{title}</p>
                        <p className={styles["desc"]}>{desc}</p>
                    </div>
                </div>
                <div className={styles["left"]} style={{width:silderWidth}}>{left}</div>
                <div className={styles["right"]} style={{width:silderWidth}}>{right}</div>
            </div>
        )
    }
}
